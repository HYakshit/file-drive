          ...
          <div class="row d-flex justify-content-center">
            <div class="content bg-light col-5 col-md-3 p-3">
              <form id="formid" method="post" enctype="multipart/form-data">
                ...
                <!-- delete -->
                <div  class="delete float-end mb-1">
                  <a  href="delete_image.php" id="deleteButton"><span class="skill-icon "><i class="fa fa-trash" aria-hidden="true" style="color: black;"></i></span></a>
                </div>
                <!-- New img -->
...
<script>
  $(document).ready(function() {
    // Disable delete button if imgSrc is 'default.jpg'
